...
turtle.penup()
turtle.goto(0, 300)  # Ajusta la posici�n vertical seg�n sea necesario
turtle.color("White")  # Color del texto
turtle.write("Feliz d�a de parte de Davidsito, se te quiere", align="center", font=("Arial", 24, "bold"))
